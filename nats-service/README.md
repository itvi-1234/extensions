...
```sh
python3 nats-service/tools/compile_extension.py --inventory ../service-operations-inventories/nats/service-operations-inventory.yaml --bridge nats-service/model/service-operations-semantic-bridge.yaml --extension-output nats-service/releases/0.1.0/runtimeconditions.extension.yaml --service-mapping-output nats-service/model/generated/nats-service-mapping.yaml
```
