...
```sh
python3 providers/nats/service/tools/compile_extension.py --inventory ../service-operations-inventories/nats/service-operations-inventory.yaml --bridge providers/nats/service/model/service-operations-semantic-bridge.yaml --extension-output providers/nats/service/releases/0.1.0/runtimeconditions.extension.yaml --service-mapping-output providers/nats/service/model/generated/nats-service-mapping.yaml
```
