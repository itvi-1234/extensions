...
Install the authoring-only dependency with `python3 -m pip install -r providers/kubernetes/api/requirements.txt`, then run the projection from the extension repository root with an immutable local copy of the source model:

```sh
python providers/kubernetes/api/tools/project_openapi.py \
  ...
  --projection-output providers/kubernetes/api/model/generated/kubernetes-v1.36-openapi-projection.yaml \
  --review-output providers/kubernetes/api/model/generated/openapi-review.md

python providers/kubernetes/api/tools/compile_extension.py \
  --source-projection providers/kubernetes/api/model/generated/kubernetes-v1.36-openapi-projection.yaml \
  --bridge providers/kubernetes/api/model/service-operations-semantic-bridge.yaml \
  --extension-output providers/kubernetes/api/releases/0.1.0/runtimeconditions.extension.yaml \
  --service-mapping-output providers/kubernetes/api/model/generated/kubernetes-service-mapping.yaml \
  --review-output providers/kubernetes/api/model/generated/extension-review.md
```
