...
python kubernetes-api/tools/project_openapi.py \
  ...
  --projection-output kubernetes-api/model/generated/kubernetes-v1.36-openapi-projection.yaml \
  --review-output kubernetes-api/model/generated/openapi-review.md

python kubernetes-api/tools/compile_extension.py \
  --source-projection kubernetes-api/model/generated/kubernetes-v1.36-openapi-projection.yaml \
  --bridge kubernetes-api/model/service-operations-semantic-bridge.yaml \
  --extension-output kubernetes-api/releases/0.1.0/runtimeconditions.extension.yaml \
  --service-mapping-output kubernetes-api/model/generated/kubernetes-service-mapping.yaml \
  --review-output kubernetes-api/model/generated/extension-review.md
```
